        ...
        <script type="text/javascript">
            jQuery(window).scroll(function () {
                if (jQuery(window).scrollTop() > 300) {
                    jQuery('.button-quick-view-product-2c5e').addClass('show');
                } else {
                    jQuery('.button-quick-view-product-2c5e').removeClass('show');
                }
            });
        </script>
                                    ...
                                    <ul class="nav navbar-nav">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu style1">
                                                <li><a href=""><img src="ananas.vn/wp-content/uploads/Menu_Nam.jpg"></a><a class="style1-title" href="">CHO NAM</a></li>
                                                <li><a href=""><img src="ananas.vn/wp-content/uploads/Menu_Nu.jpg"></a><a class="style1-title" href="">CHO NỮ</a></li>
                                                <li><a href=""><img src="ananas.vn/wp-content/uploads/Menu_Sale-off.jpg"></a><a class="style1-title" href="">OUTLET SALE</a></li>
                                                <li><a href=""><img src="ananas.vn/wp-content/uploads/Menu_Phu-kien.jpg"></a><a class="style1-title" href="">THỜI TRANG & PHỤ KIỆN</a></li>
            ...
            <div class="row">
                <div class="hot-news-cont">
                    <div class="hot-news-slide">
                        <div class="cont-item"><a href="">Bước Vào Phong Cách: Nơi Mỗi Đôi Giày Kể Một Câu Chuyện</a></div>
                        <div class="cont-item"><a href="">Bước Đi Đúng Bước Xu Hướng Với Sự Lựa Chọn Đa Dạng Của Chúng Tôi</a></div>
                        <div class="cont-item"><a href="">Bước Chân Tự Tin Với Những Đôi Giày Phản Ánh Phong Cách Của Bạn</a></div>
                        <div class="cont-item"><a href="">Từ Sự Đầm Áp Đến Sang Trọng, Chúng Tôi Có Đôi Giày Hoàn Hảo Cho Bạn</a></div>
                    </div>
                </div>
            </div>
        </div>

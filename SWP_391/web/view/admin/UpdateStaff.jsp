    ...
    <body>
        <div class="container">
            <div class="card mx-auto p-4">
                ...
                <form  action="/SWP_391/updateStaff" method="POST" onsubmit="return validateForm()" >
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        Cập nhật số điện thoại: <input type="text" name="phone" value="${c.phone}" class="form-control" required /><br>
                    </div>
                    <div class="mb-3">
